...
public class BoardServiceImpl implements BoardService {
    ...
    public void save(BoardDomain boardDomain) throws IOException { // 게시글 저장 기능
        ...
        if (boardDomain.getBoardFile().isEmpty()) {
            ...
            String storedFileName = System.currentTimeMillis() + " " + originalFilename; //.3 currentTimeMillis는 1970년부터 지금까지 시간의 밀리초를 리턴
            String savePath="C:\\Users\\JW\\Desktop\\store" + storedFileName; //.4
